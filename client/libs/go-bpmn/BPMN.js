...
function initGoJSBPMN(myDiagramDiv) {
...
function goLoadJSON(diagram, jsondata) {
      ...
      // diagram.addDiagramListener("InitialLayoutCompleted", loadDiagramProperties(diagram));  // defined below
...
function loadDiagramProperties(diagram) {
  return function() {
